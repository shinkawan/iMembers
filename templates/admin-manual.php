...
<div class="wrap imembers-admin-manual">
    ...
    <div class="imembers-manual-content" style="background: #fff; padding: 20px; border: 1px solid #ccd0d4; margin-top: 20px; max-width: 1000px; line-height: 1.6;">
        ...
        <p>iMembersでは「ページ単位」「カテゴリー単位」「記事の一部（チラ見せ）」で以下の3段階の閲覧制限が可能です。</p>
        <ul>
            <li><strong>公開:</strong> 全員が閲覧可能。</li>
            <li><strong>会員限定:</strong> ログインユーザーのみ閲覧可能。</li>
            <li><strong>有料会員限定:</strong> Stripeで決済済みの有料会員のみ閲覧可能。</li>
        </ul>
